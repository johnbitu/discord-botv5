...
module.exports = {
	...
	token: process.env.token || (TOKEN), //- Bot's Token
	clientId: process.env.clientId || (CLIENT_ID), //- ID of the bot
	clientSecret: process.env.clientSecret || (CLIENT_SECRET), //- Client Secret of the bot
